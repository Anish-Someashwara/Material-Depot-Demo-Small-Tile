export const items = {
	...
	Comfort: [
		...
		// 			price: "&#x20B9; 3,950",
		// 			info: "<p>Tripper™ is a sophisticated navigation solution, that indicates directions through an intuitive display system</p>",
		// 			is3dPreviewAvailable: false,
		// 			infoNeeded: true,
		// 		},
		// 	],
...
export const Seats = [
	...
	{
		name: "SeatBrown",
		path: "../static/models/Seats/SeatBrown",
		chunkNum: 7
	},
	{
		name: "SeatBlack",
		path: "../static/models/Seats/SeatBlack",
		chunkNum:  5
	},
